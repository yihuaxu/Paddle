...
TEST(Conv3DeluFusePass, basic) {
  ...
  auto pass = PassRegistry::Instance().Get("conv_elu_mkldnn_fuse_pass");
  ...
  // Remove 3 Nodes: CONV, elu, conv_out
  // Add 1 Node: Convelu
  EXPECT_EQ(original_nodes_num - 2, current_nodes_num);

  // Assert conv_elu op in newly generated graph
  int conv_elu_count = 0;
...
USE_PASS(conv_elu_mkldnn_fuse_pass);
